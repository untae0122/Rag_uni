...
if is_base_mode:
    ...
    ##
    poisoned_index_path = "../datasets/hotpotqa/e5_index_chanwoo_poisoned"
    poisoned_corpus_path = "../datasets/hotpotqa/poisoned_generator_corpus_shard_chanwoo.jsonl"
    ##
    ...
    results_path = os.path.join(trajectory_results_dir, 'poisoned_results_surrogate.json')
