...
class GeneralDatasetWrapper(gym.Wrapper):
  """
  A generic wrapper that loads data from a specified path.
  Expects a JSON list of objects having 'question' and 'answer' (or 'answers') fields.
  """
    ...
    try:
        with open(data_path, 'r') as f:
            if data_path.endswith('.jsonl'):
                self.data_raw = [json.loads(line) for line in f]
            else:
