#!/bin/bash
# WebThinker Experiment 5: Dynamic Retrieval (Oracle-Soft)
# Usage: ./scripts/webthinker/exp5_dynamic_retrieval.sh [GPU_ID]
...
echo "Running WebThinker Exp 5: Dynamic Retrieval"
